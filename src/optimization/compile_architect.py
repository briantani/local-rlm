...
def optimize_architect():
    logger.info("Initializing LLM for optimization...")
    ...
    logger.info("Setting up Teleprompter...")
    ...
    logger.info("Compiling Architect...")
    architect = Architect()
    ...
    logger.info(f"Saving compiled program to {save_path}...")
