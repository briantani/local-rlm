...
* \[ \] The Agent can self-correct a Python script based on REPL errors.  
* \[ \] Simple multi-step math/logic tasks work autonomously.
...
* \[ \] BudgetManager tracks costs across all threads correctly.  
* \[ \] System handles a large text summary by splitting it.